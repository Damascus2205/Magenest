...
namespace Pack\Thang\Console\Command;
...
class Thangcommand extends Command
{
    ...
    protected function configure()
    {
        ...
        $this->setName('thang:info')->setDescription('Get info about installation')->setDefinition($options);
        parent::configure();
    }
