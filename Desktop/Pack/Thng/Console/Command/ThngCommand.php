...
namespace Pack\Thng\Console\Command;
...
class ThngCommand extends Command
{
    ...
    protected function configure()
    {
        ...
        $this->setName('thng:info')->setDescription('Get info about	installation')->setDefinition($options);
        parent::configure();
    }
